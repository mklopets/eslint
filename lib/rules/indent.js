        ...
        return {
            ...
            TemplateLiteral(node) {
                ...
                node.expressions.forEach((expression, index) => {
                    ...
                    const tokenToAlignFrom = previousQuasi.loc.end.line === tokens[0].loc.start.line ? tokens[0] : null;

                    setDesiredOffsets(sourceCode.getTokensBetween(previousQuasi, nextQuasi), tokenToAlignFrom, 1);
                    setDesiredOffsets(getTokensAndComments(nextQuasi), tokenToAlignFrom, 0);
                });
            },
